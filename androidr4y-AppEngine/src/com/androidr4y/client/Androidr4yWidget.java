...
public class Androidr4yWidget extends Composite {
  ...
  interface Androidr4yUiBinder extends UiBinder<Widget, Androidr4yWidget> {
  }

  private static Androidr4yUiBinder uiBinder = GWT.create(Androidr4yUiBinder.class);
